<h2>Q&A HOW TO SETUP REDIRECTS</h2>

<h3>Can I seperate from login redirects and register redirects? Can I have a user redirected after registration based on custom field (say City for example)?</h3>

Yes. The plugin has two seperate redirects modes, login redirects and registration redirects.

<h3>How can I redirect a specific user?</h3>
...
<h3>How can I redirect all my users to their specific page after login or registration?</h3>
...
<h3>How can I redirect all users who choose their country as United States to a custom page (example)</h3>
...
<h3>How to redirect all users who have a specific role?</h3>
