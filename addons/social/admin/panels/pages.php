...
<p><?php printf(__('You must update your permalinks or Save Changes on your permalinks setup for the nice URLs to work fine.','userpro'), admin_url().'options-permalink.php'); ?></p>

<h3><?php _e('Manage Page Slugs','userpro'); ?></h3>
<p><?php _e('For a better multi-language experience, UserPro allow you to edit the slugs of the official registration/profile pages here. You must rebuild pages If you changed your slugs for the new slugs to take effect.','userpro'); ?></p>
...
<p><?php _e('By default, the extension creates frontend pages automatically. However if for some reason, these pages were removed or deleted you can rebuild them here.','userpro'); ?></p>
<table class="form-table">
