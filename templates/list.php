	...
	<div class="userpro-body">
		...
		<div class="userpro-list-item">
			...
			<div class="userpro-list-item-i" data-key="profilepicture">
				<a href="<?php echo $userpro->permalink( $user_id ); ?>"><?php echo get_avatar( $user_id, $list_thumb ); ?></a>
			</div>
			<?php } ?>
			
			<div class="userpro-list-item-d">
				
				<a href="<?php echo $userpro->permalink( $user_id ); ?>" class="userpro-list-item-name" title="<?php _e('View Profile','userpro'); ?>"><?php echo userpro_profile_data('display_name', $user_id); ?></a><?php echo userpro_show_badges( $user_id ); ?>
