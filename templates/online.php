<div class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-body">
		...
		<?php if ($online_mode == 'vertical') { ?>
		<div class="userpro-online-item">
		
			<?php if ($online_showthumb) { ?>
			<div class="userpro-online-item-i" data-key="profilepicture">
				<a href="<?php echo $userpro->permalink( $user_id ); ?>"><?php echo get_avatar( $user_id, $online_thumb ); ?></a>
			</div>
			<?php } ?>
			...
			<div class="userpro-online-item-d">
				...
				<?php if ($online_showbio && $userpro->shortbio($user_id)) : ?><div class="userpro-online-item-bio"><?php echo $userpro->shortbio( $user_id ); ?></div><?php endif; ?>
				
				<?php if (!isset($disable_name_hooks)){ /* display hooks after user name and badge */
				do_action('userpro_after_name_user_list', $user_id);
				} ?>
				
				<?php if ($online_showsocial) { ?>
		...
		<div class="userpro-online-i">
			<?php if ($online_showthumb) { ?><a href="<?php echo $userpro->permalink( $user_id ); ?>" class="userpro-online-i-thumb"><?php echo get_avatar( $user_id, $online_thumb ); ?></a><?php } ?>
