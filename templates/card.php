<div class="userpro userpro-nostyle userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-card">
		...
		<div class="userpro-card-icons"><a href="<?php echo $userpro->permalink( $user_id ); ?>" class="userpro-profile-icon"><i class="userpro-icon-link"></i></a><?php echo $userpro->show_social_bar( $args, $user_id ); ?></div>
		<?php } ?>
