...
<div class="upadmin-groups upadmin">
	...
	<div class="upadmin-section">
		<h3><?php _e('How to edit the field settings?','userpro'); ?></h3>
		...
		<div class="upadmin-new">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<span class="description"><?php _e('Enter title for this data. example: City, How did you hear about us, Twitter, Personal Website, etc.','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top">
					...
					<span class="description"><?php _e('The type of field or how a user is going to enter this data (via text, selecting a choice from dropdown, etc)','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top" class="filetypes">
					...
					<span class="description"><?php _e('A comma seperated list of allowed file types. If blank, default will be to zip, pdf, txt.','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top" class="choicebased">
					...
					</select><span class="description"><?php _e('You can also enter choices for this field manually below.','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top" class="choicebased">
					...
					<span class="description"><?php _e('Please enter one choice per line!','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top">
					...
					<span class="description"><?php _e('Help text will be displayed below field to guide users what to put in that field or show any relevant info.','userpro'); ?></span></td>
				</tr>
				...
				<tr valign="top" style="background:#999">
					<th scope="row" colspan="2"><big><?php _e('Setting up the user meta key','userpro'); ?></big></th>
				</tr>
				<tr valign="top">
					...
					<span class="description"><?php _e('Your field key must be unique for each field. It must be letters only with only underscore allowd between them.','userpro'); ?></span></td>
				</tr>
				<tr valign="top">
					...
					<span class="description"><?php _e('You can sync or use user meta from any other plugin directly and integrate it with UserPro. Unique key is not needed If you sync with existing field.','userpro'); ?></span></td>
				</tr>
				<tr valign="top">
					<th scope="row"></th>
					<td>
