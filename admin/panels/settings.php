...
<h3><?php _e('Quick Maintenance','userpro'); ?></h3>
...
<h3><?php _e('Module Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Compatibility Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Appearance and Look','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Profile Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Redirection & Backend Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Login Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Registration Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Logout Page Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Password Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Google Integration','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Twitter Integration','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Facebook Integration','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost"><?php _e('Auto Post on users Facebook wall','userpro'); ?></label></th>
		<td>
			<select name="facebook_autopost" id="facebook_autopost" class="chosen-select" style="width:300px">
				<option value="1" <?php selected('1', userpro_get_option('facebook_autopost')); ?>><?php _e('Yes','userpro'); ?></option>
				<option value="0" <?php selected('0', userpro_get_option('facebook_autopost')); ?>><?php _e('No','userpro'); ?></option>
			</select>
			<span class="description"><?php _e('When a user connect via Facebook, a post can be added automatically to his wall.','userpro'); ?></span>
		</td>
	</tr>
	
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost_name"><?php _e('Post Name','userpro'); ?></label></th>
		<td>
			<input type="text" name="facebook_autopost_name" id="facebook_autopost_name" value="<?php echo userpro_get_option('facebook_autopost_name'); ?>" class="regular-text" />
			<span class="description"><?php _e('e.g. Check out this website!, Welcome to XX website, etc.','userpro'); ?></span>
		</td>
	</tr>
	
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost_caption"><?php _e('Post Caption','userpro'); ?></label></th>
		<td>
			<input type="text" name="facebook_autopost_caption" id="facebook_autopost_caption" value="<?php echo userpro_get_option('facebook_autopost_caption'); ?>" class="regular-text" />
			<span class="description"><?php _e('e.g. URL or small text that appears below the post name.','userpro'); ?></span>
		</td>
	</tr>
	
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost_body"><?php _e('Post Body','userpro'); ?></label></th>
		<td>
			<input type="text" name="facebook_autopost_body" id="facebook_autopost_body" value="<?php echo userpro_get_option('facebook_autopost_body'); ?>" class="regular-text" />
	...
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost_description"><?php _e('Post Description','userpro'); ?></label></th>
		<td>
			<input type="text" name="facebook_autopost_description" id="facebook_autopost_description" value="<?php echo userpro_get_option('facebook_autopost_description'); ?>" class="regular-text" />
			<span class="description"><?php _e('This is the full description of the Facebook wall post.','userpro'); ?></span>
		</td>
	</tr>
	
	<tr valign="top">
		<th scope="row"><label for="facebook_autopost_link"><?php _e('Post Link','userpro'); ?></label></th>
		<td>
			<input type="text" name="facebook_autopost_link" id="facebook_autopost_link" value="<?php echo userpro_get_option('facebook_autopost_link'); ?>" class="regular-text" />
...
<h3><?php _e('MailChimp Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Envato Settings','userpro'); ?></h3>
<table class="form-table">
