...
<h3><?php _e('Check / Rebuild Profile Pages','userpro'); ?></h3>
<table class="form-table">
...
<p class="submit">
	<input type="submit" name="rebuild-pages" id="rebuild-pages" class="button button-primary" value="<?php _e('Rebuild UserPro Pages','userpro'); ?>"  />
</p>
