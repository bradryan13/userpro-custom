		...
		switch($badge){
			...
			case 'country':
				if (userpro_get_option('show_flag_in_badges') && get_user_meta($user_id,'country',true)){
					...
					return '<img class="userpro-profile-badge userpro-flag-small" src="'.userpro_url.'img/flags/mini/'.strtolower($country_meta).'.png" alt="" title="'.$country.'" />';
					}
				}
				break;
		
			case 'online':
				return '<img class="userpro-profile-badge userpro-hide-from-list" src="'.$userpro->badges_url.'online.png" alt="" title="'.__('User is online :)','userpro').'" />';
				break;
			
			case 'offline':
				return '<img class="userpro-profile-badge userpro-hide-from-list" src="'.$userpro->badges_url.'offline.png" alt="" title="'.__('User is offline :(','userpro').'" />';
				break;
		
			case 'verified':
				if ($tooltip == 'right'){
					$class = 'userpro-profile-badge-right';
				} else {
					$class = 'userpro-profile-badge';
				}
			...
			case 'unverified':
				if (userpro_get_option('verified_link')) {
					return '<a href="'.userpro_get_option('verified_link').'"><img class="userpro-profile-badge" src="'.$userpro->badges_url.'badge-unverified.png" alt="" title="'.__('Unverified Account','userpro').'" /></a>';
				} else {
					return '<img class="userpro-profile-badge" src="'.$userpro->badges_url.'badge-unverified.png" alt="" title="'.__('Unverified Account','userpro').'" />';
				}
				break;
				
			case 'facebook':
				return '<img class="userpro-profile-badge" src="'.$userpro->badges_url.'facebook.png" alt="" title="'.__('Facebook Linked','userpro').'" />';
				break;
				
			case 'twitter':
				return '<img class="userpro-profile-badge" src="'.$userpro->badges_url.'twitter.png" alt="" title="'.__('Twitter Linked','userpro').'" />';
				break;
				
			case 'google':
				return '<img class="userpro-profile-badge" src="'.$userpro->badges_url.'google.png" alt="" title="'.__('Google Linked','userpro').'" />';
				break;
				
			case 'envato':
				return '<img class="userpro-profile-badge" src="'.$userpro->badges_url.'envato.png" alt="" title="'.__('Verified Customer','userpro').'" />';
				break;
